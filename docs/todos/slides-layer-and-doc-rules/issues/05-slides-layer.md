...
- [ ] `slides/slides.css` が `gad-slide*` 以外の class を定義していない
- [ ] 面の寸法が tokens.css の token になっている
- [ ] `slides/deck.js` が面の移動と拡大を持ち、成果物へ埋め込める
- [ ] `slides/deck-samples.html` が動き、面の型を見せる
- [ ] 印刷で1面1ページの 16:9 になる
